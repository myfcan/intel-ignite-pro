  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        "gradient-primary": "linear-gradient(135deg, hsl(258 90% 66%) 0%, hsl(265 80% 64%) 33%, hsl(280 70% 68%) 66%, hsl(300 75% 70%) 100%)",
        "gradient-accent": "linear-gradient(135deg, hsl(330 81% 60%) 0%, hsl(335 78% 62%) 50%, hsl(340 75% 65%) 100%)",
        "gradient-success": "linear-gradient(135deg, hsl(158 84% 39%) 0%, hsl(160 80% 36%) 50%, hsl(162 76% 33%) 100%)",
        "gradient-glass": "linear-gradient(135deg, hsla(258 90% 66% 0.1) 0%, hsla(280 80% 68% 0.1) 50%, hsla(330 81% 60% 0.1) 100%)",
        "card-sequence": "linear-gradient(135deg, hsl(15 90% 78%) 0%, hsl(15 80% 70%) 100%)",
        "card-points": "linear-gradient(135deg, hsl(195 65% 65%) 0%, hsl(195 70% 58%) 100%)",
        "card-lessons": "linear-gradient(135deg, hsl(310 60% 75%) 0%, hsl(310 70% 68%) 100%)",
      },
      boxShadow: {
