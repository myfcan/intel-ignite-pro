    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 to-purple-50 p-8">
      <Card className="max-w-2xl mx-auto p-8 space-y-6">
        ...
        {currentSectionIndex < sections.length && (
          <div className="space-y-3">
            <div className="p-4 bg-white rounded-lg border-2 border-purple-200">
              <div className="text-sm text-gray-600 mb-1">Próxima seção a marcar:</div>
        ...
        <div className="text-sm text-gray-600 space-y-2 p-4 bg-blue-50 rounded-lg">
          <div className="font-semibold text-blue-900">Como usar:</div>
          <ol className="list-decimal list-inside space-y-1 ml-2">
            <li>Clique em Play para iniciar o áudio</li>
            <li>Ouça atentamente</li>
            <li>Quando ouvir a MAIA começar a falar o título mostrado acima, clique em "Marcar Seção"</li>
            <li>Repita para todas as seções</li>
            <li>No final, clique em "Copiar Todos os Timestamps" e me envie</li>
          </ol>
        </div>
      </Card>
    </div>
