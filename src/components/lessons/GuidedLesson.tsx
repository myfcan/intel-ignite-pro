<artifact identifier="guided-lesson-lovable-final" type="application/vnd.ant.code" language="typescript" title="GuidedLesson.tsx - CÓDIGO FINAL CORRETO PARA LOVABLE">
