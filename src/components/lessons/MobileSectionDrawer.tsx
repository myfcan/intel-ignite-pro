  ...
  return (
    <Drawer open={isOpen} onOpenChange={setIsOpen}>
      <DrawerTrigger asChild>
        <div
          className="fixed bottom-32 right-4 z-[60] flex flex-col items-center gap-1 touch-manipulation"
          aria-label="Navegação de seções"
        >
          {/* Liv Avatar em cima - subido 2px */}
          <div className="relative active:scale-95 transition-transform cursor-pointer mb-0.5">
