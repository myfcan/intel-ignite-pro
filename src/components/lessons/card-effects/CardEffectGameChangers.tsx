...
export const CardEffectGameChangers = ({ isActive = true, duration = 18 }: CardEffectProps) => {
  ...
  return (
    <motion.div 
      ...
      className="relative w-full min-h-[420px] sm:min-h-[480px] h-[60vh] max-h-[600px] rounded-2xl overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-indigo-950 p-4 sm:p-6 md:p-8 flex flex-col"
    >
      {/* Header */}
      <motion.div 
