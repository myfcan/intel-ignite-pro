 ...
 * 5. "Conexão emocional criada" badge
 *
...
export const CardEffectPromptMagic: React.FC<CardEffectProps> = ({ isActive = false }) => {
  ...
  const startAnimation = () => {
    ...
    timersRef.current.push(setTimeout(() => setScene(5), 12000)); // Badge final
  ...
  return (
    <div className="relative w-full min-h-[480px] h-[60vh] max-h-[600px] overflow-hidden rounded-xl bg-gradient-to-br from-indigo-950 via-violet-950 to-purple-950">
      {/* Background stars */}
