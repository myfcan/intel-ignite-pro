...
export const CardEffectEverydayAi = ({ isActive = true, duration = 15 }: CardEffectProps) => {
  ...
  return (
    <motion.div 
      ...
      className="relative w-full min-h-[480px] h-[60vh] max-h-[600px] rounded-2xl overflow-hidden bg-gradient-to-br from-blue-950 via-indigo-950 to-violet-950 p-8 flex flex-col"
    >
      {/* Header */}
      <motion.div 
