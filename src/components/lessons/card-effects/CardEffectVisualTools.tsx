...
export function CardEffectVisualTools({ isActive = true }: CardEffectProps) {
  ...
  return (
    <div className="relative w-full h-full min-h-[180px] flex flex-col items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 to-purple-50/30 dark:from-slate-950 dark:to-purple-950/20 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 p-6">
