...
export const CardEffectPatternVsMagic = ({ isActive = true, duration = 15 }: CardEffectProps) => {
  ...
  return (
    <motion.div 
      ...
      className="relative w-full min-h-[420px] sm:min-h-[480px] h-[60vh] max-h-[600px] rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-950 to-pink-950 p-4 sm:p-6 md:p-8 flex flex-col"
    >
      {/* Header */}
      <motion.div 
