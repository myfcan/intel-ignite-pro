...
export const CardEffectPatternVsMagic = ({ isActive = true, duration = 15 }: CardEffectProps) => {
  ...
  return (
    <motion.div 
      ...
      className="relative w-full min-h-[480px] h-[60vh] max-h-[600px] rounded-2xl overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-950 to-pink-950 p-8 flex flex-col"
    >
      {/* Header */}
      <motion.div 
      ...
      >
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-purple-500/20 border border-purple-500/30 mb-4">
          ...
          <span className="text-purple-300 text-sm font-medium">Desmistificando</span>
        </div>
        ...
        <div className="relative w-full max-w-lg">
          ...
          >
            <div className="p-6 rounded-xl bg-pink-500/10 border border-pink-500/20 text-center">
              ...
              <h3 className="text-pink-400 font-bold mb-1">"Magia"</h3>
          ...
          >
            <motion.div 
              className="p-6 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-center"
              animate={phase >= 3 ? { 
            ...
            >
              ...
              <h3 className="text-cyan-400 font-bold mb-1">Padrões</h3>
      ...
      {phase >= 4 && (
        <motion.div
          ...
          className="mt-6 p-4 rounded-xl bg-cyan-500/10 border border-cyan-500/20 text-center"
        >
          <Sparkles className="w-6 h-6 text-cyan-400 mx-auto mb-2" />
          <p className="text-white font-semibold">I.A. reconhece padrões em dados</p>
          <p className="text-cyan-300 text-sm">Não é mágica - é matemática e estatística avançada</p>
        </motion.div>
      )}
