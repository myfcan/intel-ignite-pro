...
export function CardEffectEbookView({ isActive = true }: CardEffectProps) {
  ...
  return (
    <div className="relative w-full h-full min-h-[180px] flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-50 to-orange-50/30 dark:from-slate-950 dark:to-orange-950/20 rounded-2xl border border-slate-200/50 dark:border-slate-800/50 p-6">
