      ...
      style={{
        boxShadow: isGold
          ...
          : isLocked
            ...
            : `0 8px 32px -4px rgba(99, 102, 241, 0.12), 0 4px 16px -2px rgba(236, 72, 153, 0.08), 0 0 0 1px rgba(99, 102, 241, 0.1)`,
      }}
    >
        ...
        <div
          ...
          style={{
            ...
            background: isGold
              ...
              : 'linear-gradient(135deg, #6366F1, #EC4899, #8B5CF6, #EC4899, #6366F1)',
      ...
      {!isLocked && !isGold && (
        <div
          ...
          style={{
            background: 'linear-gradient(135deg, rgba(99,102,241,0.15), rgba(236,72,153,0.12), rgba(139,92,246,0.1), rgba(236,72,153,0.15))',
            backgroundSize: '300% 300%',
        ...
        style={{
          background: isLocked
            ...
            : isGold
              ...
              : `linear-gradient(135deg, ${theme.accent}, #EC4899, #8B5CF6, ${theme.accent})`,
