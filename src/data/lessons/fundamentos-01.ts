...
**A boa notícia?** Você está no lugar certo para mudar isso agora mesmo.`,
      spokenContent: `Olá! Eu sou a MAIA, e vou te guiar nesta jornada pela Inteligência Artificial.
...
> 💡 **O mais importante:** Você **NÃO precisa** entender a matemática por trás. Você só precisa saber **USAR** essa ferramenta a seu favor.`,
      spokenContent: `Então, o que é Inteligência Artificial de verdade?
...
É como ter um **assistente pessoal disponível 24/7** que sabe sobre praticamente qualquer assunto. **E de graça!**`,
      spokenContent: `Deixa eu te mostrar onde você já usa IA todos os dias sem perceber.
...
Pessoas comuns, sem formação em tecnologia, estão ganhando **R$ 500 a R$ 3.000 extras por mês** oferecendo:
...
> 🎯 A questão não é **SE** você vai usar IA, mas **QUANDO** você vai começar.`,
      spokenContent: `Agora a pergunta de ouro: por que VOCÊ, especificamente, precisa aprender isso agora?
...
*💡 Lembre-se: Não existe pergunta boba. A IA está aqui para te ajudar. Quanto mais você praticar, melhor vai ficar!* 😊`,
      spokenContent: `Então, qual é o seu próximo passo concreto?
