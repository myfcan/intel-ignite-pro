...
import { ArrowLeft, Clock, Brain, Zap, Rocket, Target, TrendingUp, GraduationCap } from 'lucide-react';
...
const COURSE_ICONS: Record<string, LucideIcon> = {
  Brain, Zap, Rocket, Target, TrendingUp, GraduationCap,
};
          ...
          <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6 md:py-8">
            ...
            <div className="space-y-4">
              {courses.map((course, index) => {
                ...
                const IconComponent = COURSE_ICONS[course.icon || ''] || GraduationCap;
