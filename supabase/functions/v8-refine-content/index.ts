...
6. **Preservar estrutura**: NÃO altere marcadores como [QUIZ], [PLAYGROUND], [EXERCISE:tipo], títulos ##, nem a organização das seções. Copie-os EXATAMENTE como estão. NÃO insira tags de prosódia/emoção como [excited], [pause], [warm] etc. — o modelo de áudio atual não as suporta.
